...
public class plant_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String infoPlant = "The aibika is a flowering plant in the mallow family Malvaceae. It was formerly considered a species of Hibiscus, but is now classified in the genus Abelmoschus. The plant is also known as the sunset muskmallow, sunset hibiscus, or hibiscus manihot.";
        String Family = "Family of the plant: Malvaceae";
        ...
        plantImage.setImageResource(R.drawable.aibika); // image of the plant
        ...
        if(bundle != null){
            String getName = (String) bundle.get("Aibika");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.help){ // if user click help button
            startActivity(new Intent(plant_3.this,PopHelp5.class));
        ...
        plant.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                if (e == null) {
                    ...
                    Toast.makeText(plant_3.this, "Plant was added", Toast.LENGTH_SHORT).show();
                } else {

                    Toast.makeText(plant_3.this, "Plant was not added", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
