...
public class AlarmReceiver  extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(intent.getAction().equals(AlarmsSetting.ALARM_ALERT_ACTION) && type !=0) {
            ...
            Log.e("######This Alert#####", "alarmsSetting.getNextAlarm()" + formatter.format(new Date(alarmsSetting.getNextAlarm())));
            Log.e("####Current time###", "System.currentTimeMillis()" + formatter.format(new Date(System.currentTimeMillis())));
            if (alarmsSetting.getNextAlarm() + 1000 * 30 < System.currentTimeMillis()){//解决闹钟广播比设置时间闹钟快的问题
                Log.e("####Invalid Alert#####", "Not implement");
                return;
            }
            Log.e("####Pop up###", " ");
